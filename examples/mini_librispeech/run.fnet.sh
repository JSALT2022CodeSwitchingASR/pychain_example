...
if [ $stage -le 2 ]; then
  ...
  utils/prepare_lang.sh data/local/dict_nosp \
    "<UNK>" data/local/lang_tmp_nosp data/lang/lang_nosp

  local/format_lms.sh --src-dir data/lang/lang_nosp data/local/lm
  # Create ConstArpaLm format language model for full 3-gram and 4-gram LMs
  utils/build_const_arpa_lm.sh data/local/lm/lm_tglarge.arpa.gz \
    data/lang/lang_nosp data/lang/lang_nosp_test_tglarge
fi
